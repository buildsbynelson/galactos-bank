  ...
  const handleShare = () => {
    ...
    if (navigator.share) {
      navigator.share({
        ...
        text: `Transfer of $${parseFloat(transferResult.transaction.amount).toFixed(2)} to ${transferResult.transaction.receiver}. Reference: ${transferResult.transaction.reference}`,
